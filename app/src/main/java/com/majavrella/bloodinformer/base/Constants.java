...
public class Constants {
    ...
    public static final String pinRegex = "^[0-9]{4}$";
    ...
    public static final String kForgotFragment = "Forgot Password";
    ...
    public static final String pinErrorText = "You have entered wrong pin!";
