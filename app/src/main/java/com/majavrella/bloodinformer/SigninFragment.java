...
import com.majavrella.bloodinformer.user.ForgotPassword;
...
public class SigninFragment extends BaseFragment {
    ...
    @Bind(com.majavrella.bloodinformer.R.id.user_mob) EditText mUserMobile;
    ...
    @Bind(com.majavrella.bloodinformer.R.id.signin) Button mSignin;
    @Bind(com.majavrella.bloodinformer.R.id.textRegister) TextView mTextRegister;
    @Bind(com.majavrella.bloodinformer.R.id.lostPassword) TextView mLostPassword;
