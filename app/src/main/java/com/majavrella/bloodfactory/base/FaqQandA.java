...
public class FaqQandA {

    public static final String[] faqQuestions = {
            "What is blood?",
            "What should be done before donating blood?",
            "What should be done during donating blood?",
            ...
            "Then why people above 60 years of age are not allowed to donate blood in India?",
            ...
            "Will there be any good if blood is transfused to a patient on the 34th day after collection from the donor?",
            "Which are the states of India where blood donation movement can be palpably felt?",
            "Which country of the world has the best blood transfusion service totally dependent on voluntary donors?",
            "Why does blood coagulates when it comes outside the body but does not coagulate inside the body?",
    ...
    public static final String[] faqAnswers = {
            "Blood is the familiar red fluid in the body that contains white and red blood cells, platelets, proteins, and other elements. ",
